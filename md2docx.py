...
def diagram_tools_available() -> bool:
    mmdc = find_tool(
        "mmdc",
        "tools/mermaid/mmdc.cmd",
        f"tools/mermaid/node_modules/.bin/{exe_name('mmdc')}",
        "tools/mermaid/node_modules/.bin/mmdc.cmd",
        "tools/mermaid/node_modules/.bin/mmdc",
    )
    plantuml = find_tool("plantuml", "tools/plantuml/plantuml.bat", "tools/plantuml/plantuml.exe")
